...
<style>
    ...
    .dropdown-content {
        ...
        background-color: rgba(var(--surface-color-rgb), 0.8); /* Semi-transparent background */
    }
    @keyframes dropSlide {
    ...
    .dropdown-header { padding: 15px 20px; border-bottom: 1px solid var(--border-color); display: flex; justify-content: space-between; align-items: center; background: var(--hover-bg); }
    .dropdown-header h4 { font-size: 0.9rem; font-weight: 700; margin: 0; color: var(--text-color); }
    ...
    .notif-img, .notif-profile-img { width: 40px; height: 40px; border-radius: 10px; object-fit: cover; flex-shrink: 0; display: flex; align-items: center; justify-content: center; }
    ...
    .notif-info { flex: 1; }
    .notif-info p { font-size: 0.85rem; color: var(--text-color); line-height: 1.4; margin: 0 0 4px 0; }
    .notif-info span { font-size: 0.75rem; color: var(--text-muted); }

    .dropdown-link { display: flex; align-items: center; gap: 12px; padding: 12px 20px; text-decoration: none; color: var(--text-color); font-size: 0.85rem; font-weight: 500; transition: 0.3s; }
    .dropdown-link:hover { background: var(--hover-bg); color: var(--accent-color); padding-left: 25px; }
    .logout-link { color: #ef4444 !important; }
    .logout-link:hover { background: #fef2f2; color: #dc2626 !important; }

    .profile-head { flex-direction: column; text-align: center; gap: 10px; padding: 25px 20px; border-bottom: 1px solid var(--border-color); }
    .avatar-circle.large { width: 60px; height: 60px; font-size: 1.5rem; }
</style>