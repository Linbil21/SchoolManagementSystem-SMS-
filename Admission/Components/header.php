...
<?php if (isReadOnly()): ?>
    <div style="background: linear-gradient(90deg, #6366f1 0%, #4f46e5 100%); color: white; padding: 8px 15px; text-align: center; font-size: 0.75rem; font-weight: 700; letter-spacing: 0.5px; display: flex; align-items: center; justify-content: center; gap: 10px;">
        <i class="fas fa-eye"></i> <span>PEEK MODE: You are viewing the Admission Portal as a Super Admin. Data modification is disabled.</span>
...
@import url('https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@300;400;500;600;700;800&display=swap');
    ...
    .dropdown-content {
        ...
        z-index: 9999;
        overflow: hidden;
        animation: dropSlide 0.4s cubic-bezier(0.165, 0.84, 0.44, 1);
        backdrop-filter: blur(10px);
    }
